...
import { limitadorRecuperacaoSenha, limitadorLogin, sincronizarLimitadorLogin } from '../middlewares/rateLimiter.js';
 ...
 * @access Public
 */
router.post('/login', sincronizarLimitadorLogin, limitadorLogin, AutenticacaoController.login);
router.post('/desbloquear', AutenticacaoController.desbloquear);
router.post('/remover-bloqueio', verificarToken, AutenticacaoController.removerBloqueio);
